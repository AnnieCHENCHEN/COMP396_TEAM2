...
3. For turetle trading strategy, run "optimise_turtle.R" can obatin the results of optimisation of turetle trading strategy with random 5 series group. Run "optimise_turtle2.R" can obtain.
