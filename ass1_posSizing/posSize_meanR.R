...
# STRATEGY
#################################################################
strategyFile <-'strategies/meanReversion.R'
...
################################################################
# STRATEGY PARAMETERS
PAR <- list(lookback=20,sdParam=1.5,series=1:10,posSizes=rep(1,10))
...
PAR <- list(lookback=20,sdParam=1.5,series=1:10,posSizes=positionSizes)
